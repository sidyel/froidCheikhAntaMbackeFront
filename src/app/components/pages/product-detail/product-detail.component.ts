        ...
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="p-6">
              ...
              <!-- Actions - TAILLES AUGMENTÉES -->
              <div class="border-t pt-6 space-y-6">
                <!-- Contact - TAILLE AUGMENTÉE -->
                ...
                <div *ngIf="produit.ficheTechniquePDF">
                  <a
                    ...
                    <span class="text-base font-medium">Télécharger la fiche technique</span>
                  </a>
                </div>
...
export class ProductDetailComponent implements OnInit, OnDestroy {
  ...
  // NOUVEAU: Méthodes pour la galerie d'images
  ...
  nextImage(): void {
    if (this.produit?.listeImages && this.selectedImageIndex < this.produit.listeImages.length - 1) {
      ...
      this.selectedImageIndex = 0; // Revenir à la première image
    }
  }
  ...
  previousImage(): void {
    if (this.selectedImageIndex > 0) {
      ...
      this.selectedImageIndex = this.produit.listeImages.length - 1; // Aller à la dernière image
    }
  }
